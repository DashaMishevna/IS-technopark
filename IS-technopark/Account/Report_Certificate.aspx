<%@ Page Title="Сертификат" Language="C#" AutoEventWireup="true" CodeBehind="Report_Certificate.aspx.cs" Inherits="IS_technopark.Account.Report_Certificate" MasterPageFile="~/Site.Master"%>
...
<br>
    ...
    <asp:Button ID="Button1" runat="server" Text="Выбрать" CssClass="btn btn-default" Font-Size="12pt" BackColor="#CEE5F3" Height="33px" style="text-align:center" OnClick="Button1_Click"/>
    <br>
    ...
    <br>
    <asp:Button ID="Button2" runat="server"  Text="Вывести" CssClass="btn btn-default" Font-Size="12pt" BackColor="#CEE5F3" Height="33px" style="text-align:center"  />
    <br />
    <br>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="SelectList" TypeName="IS_technopark.Account.Report_Certificate"></asp:ObjectDataSource>
