...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class='form-label'>
        <asp:Label ID="Label2" runat="server" Text="Фамилия" style="margin-right:5px; float:right"></asp:Label>
    </div>
    <div class='form-row'>
    ...
    <br>
    <div class='form-label'>
        <asp:Label ID="Label3" runat="server" Text="Направление" style="margin-right:5px; float:right" ></asp:Label>
    </div>
    <div class='form-row'>
        <asp:DropDownList ID="DropDownList1" runat="server"  CssClass="btn btn-default" AutoPostBack="True" DataTextField="LABORATORY" DataValueField="LABORATORY" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" style="margin-right:30px; width:225px "></asp:DropDownList>
    ...
    <br>
    <div class='form-label'>
        <asp:Label ID="Label5" runat="server" Text="Школа" style="margin-right:5px; float:right"></asp:Label>
    </div>
    <div class='form-row'>
        <asp:TextBox ID="TextBox3" runat="server" Width="225px" Height="30px"  CssClass="btn btn-default" style="margin-right:30px"></asp:TextBox>
    ...
    <br>
    <div class='form-label'>
         <asp:Label ID="Label8" runat="server" Text="Дата рождения" style="margin-right:5px"></asp:Label>
    </div>
    <div class='form-row'>
    ...
    <div class='form-label'>
        <asp:Label ID="Label9" runat="server" Text="Телефон" style="margin-right:5px"></asp:Label>
    </div>
    <div class='form-row'>
