...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="margin-left:50px">
        ...
        <div class='form-row'>
            <asp:TextBox ID="TextBoxFirst" runat="server" Width="225px" Height="30px"  CssClass="btn btn-default" style="margin-right:20px"/> 
        ...
        <div class='form-row'>
            <asp:TextBox ID="TextBox3" runat="server" Width="225px" Height="30px"  CssClass="btn btn-default" style="margin-right:20px"></asp:TextBox>
        ...
        <div class='form-row'>
            <asp:TextBox ID="TextBox4" runat="server" Width="225px" Height="30px" Type="date" CssClass="btn btn-default"></asp:TextBox>
        </div>
        <br>
        <br>
        <div class='form-label'>
        ...
        <div class='form-row'>
            <asp:TextBox ID="TextBox7" runat="server" Width="225px" Height="30px" Type="Date"  CssClass="btn btn-default" style="margin-right:20px"></asp:TextBox>
        ...
        <div class='form-row'>
            <asp:TextBox ID="TextBox8" runat="server" Width="225px" Height="30px"  CssClass="btn btn-default" style="margin-right:20px"/> 
        ...
        <div class='form-row'>
            <asp:TextBox ID="TextBox11" runat="server" Width="225px" Height="30px" CssClass="btn btn-default" style="margin-right:20px"></asp:TextBox>
            <asp:Label ID="Label15" runat="server" Text="Телефон рабочий" style="margin-right:5px"></asp:Label>
            <asp:TextBox ID="TextBox12" runat="server" Width="225px" Height="30px" CssClass="btn btn-default"></asp:TextBox>
        </div>
        <br>
        <br>
        <div class='form-label'>
        ...
        <div class='form-row'>
            <asp:TextBox ID="TextBox13" runat="server" Width="225px" Height="30px"  CssClass="btn btn-default"></asp:TextBox>
        </div>
        <br>
        <br>
        <div class='form-label'>
        ...
        <div class='form-row'>
            <asp:TextBox ID="TextBox14" runat="server" Width="500px" Height="30px"  CssClass="btn btn-default" style="margin-right:20px"></asp:TextBox>
            <asp:Label ID="Label18" runat="server" Text="Должность" style="margin-right:5px" ></asp:Label>
            <asp:TextBox ID="TextBox15" runat="server" Width="225px" Height="30px"  CssClass="btn btn-default"></asp:TextBox>
        </div>
        <br>
        <br>
    </div>
    ...
    <div class="form-group" style="text-align:center">
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Добавить" Width="225px" Height="40px" CssClass="btn btn-default" Font-Size="15pt" BackColor="#CEE5F3"  />
        <br/>
        <br/>
