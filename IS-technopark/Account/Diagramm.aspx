...
<asp:Content  ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Диаграмма по направлениям" />
    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Воронка по году" />
</asp:Content>