...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class='form-row'>
            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="btn btn-default" AutoPostBack="true" style="margin-right:15px; margin-bottom:20px" Height="30px" Width="280" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"  ></asp:DropDownList>
