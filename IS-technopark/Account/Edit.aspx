...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2 style="text-align:center; margin-top:40px" >Вход</h2>
    <div class="login" style="text-align:center">
        <br />
        <asp:Label ID="Label1" runat="server" Text="Имя сотрудника" Font-Size="10pt"></asp:Label>
        <br/>
        ...
        <div class="form-group">
        <asp:Button ID="Button1" runat="server" Text="Выполнить вход" Width="225px" OnClick="Button1_Click" Height="40px" CssClass="btn btn-default" Font-Size="12pt" BackColor="#CEE5F3" />
        <br/>
        <br/>
