...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>" SelectCommand="SELECT TECHNOPARK.EMPLOYEES.FIO, TECHNOPARK.DIR_POSITION.DIR_POSITION, TECHNOPARK.EMPLOYEES.ID_EMPLOYEES FROM TECHNOPARK.DIR_POSITION INNER JOIN TECHNOPARK.EMPLOYEES ON TECHNOPARK.DIR_POSITION.ID_DIR_POSITION = TECHNOPARK.EMPLOYEES.POSITION WHERE (TECHNOPARK.EMPLOYEES.POSITION &lt;&gt; 3) ORDER BY TECHNOPARK.EMPLOYEES.FIO" UpdateCommand="UPDATE TECHNOPARK.EMPLOYEES SET FIO = 'qwe' WHERE 1=0" DeleteCommand="DELETE FROM TECHNOPARK.EMPLOYEES WHERE ID_EMPLOYEES = :ID_EMPLOYEES and 1=0"></asp:SqlDataSource>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" AllowPaging="True" CellPadding="5" CellSpacing="3" PageSize="5" GridLines="Vertical" BackColor="White" BorderWidth="0px" DataKeyNames="ID_EMPLOYEES" OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting">
        <Columns> 
            <asp:TemplateField>
                <ItemTemplate>
